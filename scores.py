...
class Scores(): # Вывод счета игровой сессии
    ...
    def image_score(self): # Преобразование текста счета в графику
