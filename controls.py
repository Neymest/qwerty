...
def update_bullets(screen, stats, sc,  inos, bullets): # Обнова позиций пуль
    bullets.update()
...
def gun_kill(stats, screen, sc, gun, inos, bullets): # столкнование пушки и армии
...
def update_inos(stats, screen, sc, gun, inos, bullets): # обновление позиции ино
    inos.update()
    if pygame.sprite.spritecollideany(gun, inos):
        gun_kill(stats, screen, sc, gun, inos, bullets)
    inos_check(stats, screen, sc, gun, inos, bullets)

def inos_check(stats, screen, sc, gun, inos, bullets): # добрались ли до края
